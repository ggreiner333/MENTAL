...
def normalize_data(path="/data/zhanglab/ggreiner/MENTAL/TDBRAIN"):
    ...
    # Load Data
    inds = np.load(os.path.join(path, 'small_imputed_complete_samples_EC_depression.npy'))
    ...
    np.save(file=os.path.join(path, 'normalized_small_imputed_complete_samples_EC_depression.npy'), arr=normalized)

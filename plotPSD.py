...
def plot_MENTAL_MultiClass_Comparison():
    ...
    # For EC Multi Class
    e2_accs = np.load("C:\\Users\\glgre\\Documents\\ResearchCode\\TOP5_e2_MENTAL_EC_IMPUTED_ACCS700.npy", allow_pickle=True)
    e3_accs = np.load("C:\\Users\\glgre\\Documents\\ResearchCode\\TOP5_e3_MENTAL_EC_IMPUTED_ACCS700.npy", allow_pickle=True)
    ...
    axis[0].set_xticks(ticks=np.arange(0,701,100), labels=np.arange(0,701,100), fontsize=14)
    ...
    print(f"\tMENTAL e2: {e2_accs[699]}")
    print(f"\tMENTAL e3: {e3_accs[699]}\n")

    print(f"\tmax MENTAL e2: {np.max(e2_accs)}")
    print(f"\tmax MENTAL e3: {np.max(e3_accs)}")

    # For EO Multi Class
    e2_accs = np.load("C:\\Users\\glgre\\Documents\\ResearchCode\\TOP5_e2_MENTAL_EO_IMPUTED_ACCS700.npy", allow_pickle=True)
    e3_accs = np.load("C:\\Users\\glgre\\Documents\\ResearchCode\\TOP5_e3_MENTAL_EO_IMPUTED_ACCS700.npy", allow_pickle=True)
    ...
    axis[1].set_xticks(ticks=np.arange(0,701,100), labels=np.arange(0,701,100), fontsize=14)

...
def generate_EC_Samples(ptc, psd, out):
    ...
    np.save(os.path.join(out,'only_EC_mdd_healthy_samples'), all_complete_samples)
...
def generate_EO_Samples(ptc, psd, out):
    ...
    all_complete_samples = np.array(complete_samples)
    np.save(os.path.join(out,'only_EO_mdd_healthy_samples'), all_complete_samples)
...
def generate_EC_EO_Samples(ptc, psd, out):
    ...
    all_complete_samples = np.array(complete_samples)
    np.save(os.path.join(out,'only_EC_EO_mdd_healthy_samples'), all_complete_samples)

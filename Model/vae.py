...
class VAE_Both(nn.Module):
    ...
    def __init__(self, input_dim, z_dim):
        ...
        self.encode1 = nn.Linear(input_dim, 7864)
        self.encode2 = nn.Linear(7864, 3000)
        self.encode3 = nn.Linear(3000, 1024)
        ...
        self.decode1 = nn.Linear(z_dim, 1024)
        self.decode2 = nn.Linear(1024, 3000)
        self.decode3 = nn.Linear(3000, 7864)
        self.decode4 = nn.Linear(7864, input_dim)
